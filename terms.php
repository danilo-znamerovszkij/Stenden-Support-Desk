        ...
        <div class="wrapper">
            ...
            <div id="content-wrapper">
                ...
                <div class="content" id="terms">
                    ...
                    If you have given us permission to do so, Stenden Support Desk  will also use your email address for Custom Audience targeting on Facebook. For this purpose, we code your email address by hashing it. Hashing is a technique whereby your email address is converted into a unique code; a technique which is also used to be able to securely check passwords. We only share the hash value with Facebook and not your unencrypted email address. Additional information about Facebook's policy is available regarding the collection, processing, use, purpose, and scope of data. This also includes privacy settings.
                    If you would like to block not only Facebook adverts by Stenden Support Desk  but also content by third parties, you can get more information about how to block third-party advertising.
                    Please note: If you have used one of the options above to block targeted Facebook advertising, you may still see Stenden Support Desk advertising on Facebook. This is the case, for example, if Facebook links your profile to a general advertising campaign launched by Stenden Support Desk. Unfortunately, this is a process over which we have no control.
                    <h2>Security</h2>
