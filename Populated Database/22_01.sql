...
--
-- Хост: 127.0.0.1
-- Время создания: Янв 22 2018 г., 16:34
...
(1, 'Hello bro', 1, 2, '2018-01-17 12:12:16'),
(2, 'This is message two', 6, 1, '2018-01-17 12:52:56');
...
(1, 1, 'Rene laan', '051231231231', 'rene.laan@stenden.com', 'rene', '$2y$10$ApbH.nZ9yHtsP5MJdwZCxu4EAC62B/ruJdlg3DTdZip9wibz33wKi', 0, 3, 1),
(2, 1, 'Bob Saget', '2134kj231', 'asdkjh@kjhsdaf.com', 'employee', '$2y$10$Yzx.Gc.mKRgeQJw7lP53N.7uaHqMGZZkcqPrtngRANoggWQKims5K', 1, 2, 1),
(3, 0, 'Henri Kuvalis', '(794) 664-9281 ', 'raynor.luna@hotmail.com', 'ohansen', '$2y$10$h2X7JvaPHNsBFdUWEdmqi.Sax9E0IdiEyV9xtVI386xpBYNSkG/zu', 1, 1, 18),
(4, 0, 'Monica Stokes IV', '1-254-737-4199 ', 'elliot.funk@watsica.net', 'tito.keeling', '$2y$10$zUtP6wG456qVtixDIsE0p.OWGMGVV9fN5FClq5ibbg9d.bH7LJWu6', 1, 1, 18),
(5, 0, 'Delphia Maggio', '(421) 810-5908 ', 'zbuckridge@hotmail.com', 'shania18', '$2y$10$iM2xVZX8R4X6rtOOpHlg3OdE1w1jU2H8gpxsX5saa6Y6vNwDG8eVu', 1, 1, 37),
(6, 0, 'Dr. Jessyca Hand II', '482.964.7657 x9', 'guido43@yahoo.com', 'beahan.ned', '$2y$10$jfzxKK5pPVMPyHSNkr7yTuVXLHuZBLqH341FBf1US2M3a2ml/ny82', 0, 1, 19),
(7, 0, 'Mr. Ola Connelly Sr.', '(342) 490-3586 ', 'odavis@weber.com', 'lzemlak', '$2y$10$En2LWUuaydztnnFt0sjZ1uv4wwMOihT0634Q2ZhcOH8t7JQSljvnS', 0, 6, 30),
(8, 0, 'Dianna Walter', '236.680.2775', 'tremblay.felicia@yahoo.com', 'pedro52', '$2y$10$rwD6ckFsFsTBQRMfxGv2q.jiT18JWex8oBuKgTkukwkdSHTYaLQDK', 0, 1, 34),
(9, 0, 'Alda Moen', '+1-506-761-9416', 'clarissa64@sanford.com', 'hullrich', '$2y$10$JezuOEw9DkHYTkwGrSlDa.GO6xih7fcahHkXVOcBrlp7xRenduaTC', 0, 6, 34),
(10, 0, 'Zander Bartell', '(616) 994-9864 ', 'rschroeder@yahoo.com', 'genesis69', '$2y$10$WQFAYtIRbZmYd8yAgCt2G.ahgddAjTD/26v2rSmV60jNVNVk8.zvO', 0, 6, 8),
(11, 0, 'Una Funk', '230-891-3713 x3', 'gerard.mcclure@yahoo.com', 'armand.senger', '$2y$10$1INEkSuv7rR..GDU7AeiVeImSCP3zfjLcsEZQPuz/okOF1WHUj4Pa', 0, 1, 39),
(12, 0, 'Prof. Athena Wehner IV', '+1-306-344-6599', 'ywalsh@hotmail.com', 'douglas.oconner', '$2y$10$wq5yEeLccRWrjdHcPFOySe7lXTR2qzq0etOlrOAGElqFIFpE9mC.m', 0, 6, 26),
(13, 0, 'Mr. Graham Turner IV', '1-585-644-3050', 'hfritsch@bruen.com', 'beahan.providenci', '$2y$10$G1P2ZCLVefCn2OtyAj8S1uWocKB/Fiw00kE.DLMnvvShmcPcFZ1ai', 0, 1, 45),
(14, 0, 'Miss Lucy Nolan DDS', '315.285.0193', 'minerva15@kub.com', 'karl62', '$2y$10$SVVxMDyhk.J1VMRnmMc8d.lkzBIuiBvuShQ7Sr5z7IujBbQzbOzzy', 0, 1, 6),
(15, 0, 'Romaine Fritsch', '+1.517.559.3958', 'ostroman@hotmail.com', 'nya.mcdermott', '$2y$10$Vg6wHWJAk5JAESYWzfqOxuaLynJ9qhqiE5wYV0IomC0qvnvEtEY0a', 0, 1, 32),
(16, 0, 'Morris Pollich', '931-752-4104 x7', 'keira19@yahoo.com', 'tmills', '$2y$10$4QHQp2glAcNDDrrQ/VelbuTYBnBuuJYagWERQouoW9trpvQG5Gglq', 0, 1, 10),
(17, 0, 'Alden Oberbrunner', '+1-241-955-8974', 'daugherty.humberto@hotmail.com', 'josh.trantow', '$2y$10$QTjdZJziuYKwlrgnEr.y9.1ionsNkymCjaW7NfJRrv34Uwt9HcZJ6', 0, 1, 23),
(18, 0, 'Genesis Wunsch', '1-561-863-8452', 'aoconnell@hotmail.com', 'mayert.rosetta', '$2y$10$nJ.awNwqqNKrmXAZMcjahekPKLQlXvWdoHnDx/vVIrBsLFRP9aMoq', 0, 6, 29),
(19, 0, 'Sydney Hansen', '(694) 557-0817', 'ibrahim01@hamill.biz', 'brandyn.bosco', '$2y$10$XmtqPewqYKH6hWxJi8be/eHkJSUdfIwSTA0NCy6F9ramdCsRX74kK', 0, 1, 24),
(20, 0, 'Rico Schmeler', '620-442-9700 x7', 'itzel16@yahoo.com', 'herman.windler', '$2y$10$McL6V3yJKu52/T12Sr3CruNZ5Gq/LKm3mywy1CmWYkUy9E4EB5rxm', 0, 1, 5),
(21, 0, 'Miss Colleen Shields PhD', '+1 (329) 936-67', 'lulu97@hotmail.com', 'murazik.josefina', '$2y$10$PqJEVZR5sMgNEK0jCz8QrOiIzpeRmhtXNHBs.3yJXx0112YfGJNbC', 0, 6, 49),
(22, 0, 'Dave Mayert', '+1-431-254-7530', 'ckassulke@yahoo.com', 'schulist.velva', '$2y$10$N9D7p6WP/vKW4nV4GunMJ.gcBMyPzDXvTgPIO4pOP2WRd.gZIZJ4a', 0, 1, 16),
(23, 0, 'Prof. Tressa Donnelly', '832-823-4692', 'zdickinson@gmail.com', 'bhuel', '$2y$10$E5AyOUpGFZ61D.pdTLqlP.0Ikn6vr3xwPDQhaOqUzxwhCoEYP8zMO', 1, 1, 27),
(24, 0, 'Missouri Robel', '(465) 376-5048', 'adams.mazie@stamm.net', 'halvorson.carolyn', '$2y$10$WvXbhtJLYjhCzK8ItNvKhegwAzUS86Ell0g9SZvLlAg33tCqk4cnW', 1, 6, 4),
(25, 0, 'Effie Toy II', '959.353.1773 x6', 'egrimes@gmail.com', 'ywyman', '$2y$10$G/njFuSuJ8ZqE/4ResoJBOK.xom4mRmoFuMP3t0o63qJzJuIJLeW2', 0, 6, 15),
(26, 0, 'Pasquale Willms', '1-471-620-3578', 'judah.brekke@huels.org', 'yasmin14', '$2y$10$WCmwfnXLLBDvKLrAgH9FIexkSgd2796iDzv8frqMnks.fnJiK6QN.', 0, 6, 3),
(27, 0, 'Howell Marks', '297.582.2489', 'mohammad64@gaylord.biz', 'pouros.darwin', '$2y$10$3KnN8c.gcKdQMCfWeMPd3emMma0lL.qTBpty2Xe64wQHA8MYtzhiO', 1, 6, 11),
(28, 0, 'Braden Boehm', '204-876-0104', 'joaquin79@olson.com', 'hickle.maximo', '$2y$10$UxE4ERcVaPlLVXyfzx58KebO3Hz28GCbLeQ5HXUkv4Lzx8JU9hHjG', 1, 6, 48),
(29, 0, 'Prof. Tina Huel IV', '(368) 986-9130 ', 'sbode@powlowski.com', 'carolanne49', '$2y$10$T2DD5uAY0QvzjFQcAXSXsepWb5Fyl1uLx1qbtLFVoXspOOts7dByq', 1, 1, 3),
(30, 0, 'Mrs. Viola Miller IV', '+1.753.483.3449', 'wyman.ally@stokes.biz', 'paul13', '$2y$10$IRPxwauOBB4Plj4pJKfUROHR0MZWYONRbeUN16ab9bjfmVKs3ZnK6', 0, 1, 4),
(31, 0, 'Royal Dooley', '1-581-789-2146', 'berniece.gaylord@ebert.biz', 'berry16', '$2y$10$ud9zdKLAvHN3iMYlJkDXjuhXuuBMWFPaAUOZo0ioLusFFyNA2yuw2', 0, 6, 10),
(32, 0, 'Cordie Bogan', '767-241-0309 x1', 'evert.johnson@hamill.com', 'rvandervort', '$2y$10$LTQPhZ/5VxjEol66Oj3GyeHaUiGG15dy25aCI8lGK1ccWANIdX7xm', 0, 6, 5),
(33, 0, 'Dorthy Hegmann', '402.605.5707', 'nfeeney@mann.com', 'jcollins', '$2y$10$Pq2ZW4UEIvyglfXGHlWxQuVJ5C13MCnWNAlZHo7nDSEfvo6UEPLu2', 0, 6, 39),
(34, 0, 'Ms. Georgiana DuBuque III', '(794) 718-9574 ', 'elva26@romaguera.com', 'johnny62', '$2y$10$h7eHBPQYYqGm6i9FIqeyMeJT7jBrKgCwXE0J2rj7jnjaXphaob9Gq', 0, 6, 32),
(35, 0, 'Addison Brekke', '864-360-7596', 'ylangosh@hotmail.com', 'lbeer', '$2y$10$tLV9kGpJwZPkTPQ5ocMAJOn7To/nYyXx1za7Sgu0CsKtkOFXLiO/K', 0, 6, 14),
(36, 0, 'Mrs. Janie West V', '1-654-531-9581 ', 'renner.litzy@yahoo.com', 'mavis98', '$2y$10$R4.wRj5UIusunSHEpx56aOdVI8w19D4URUXOuPLyI30mBrDeFbsve', 0, 6, 18),
(37, 0, 'Dr. Graciela Sanford', '1-549-683-4540 ', 'fae.gaylord@stamm.com', 'vswift', '$2y$10$V4rJq2UouMYotBa8i0VyVuenDkx76KX/z7HvK06r3v0O4oojnzkNG', 1, 1, 30),
(38, 0, 'Rhea Little', '782-300-1090 x4', 'bernier.trever@gmail.com', 'deshawn.hermann', '$2y$10$698ciWrgAgj/2miflAvVEeG..3eU4iWfEPrfIyrEytHRXEn7NhDdC', 0, 1, 50),
(39, 0, 'Rosario Swaniawski', '443-574-2190 x9', 'antonia51@gmail.com', 'umayer', '$2y$10$8gonh1eQZJqQoBetbpr0NuMN8r25C/bRiS.qC7Yja8Sa.ItkQz4qq', 1, 6, 42),
(40, 0, 'Mrs. Era Batz DVM', '1-709-452-3565 ', 'swillms@pollich.biz', 'ogutmann', '$2y$10$RB2YA8Qn9RMP0HTqDprfMO8MOVRg4m5JrmuOFTnFncACt.3zUjL42', 0, 6, 24),
(41, 0, 'Eric Carter MD', '1-406-817-5282 ', 'gokeefe@kuhlman.info', 'wisozk.laurianne', '$2y$10$13z9jafrG6KUok9rBBmpO.qlzr8MBFWVs.5geOhpumOQX7husK3Um', 0, 6, 9),
(42, 0, 'Eladio Kuhn', '(860) 960-2064 ', 'carmine59@lemke.com', 'uhoppe', '$2y$10$JxZBIqio3JOTPTluMaG94OfcHU4MSsOW0DAtc8fi9NBv6tDAF3ZR2', 0, 1, 4),
(43, 0, 'Brayan Jast Sr.', '(561) 849-0441', 'bins.carol@boehm.com', 'yking', '$2y$10$ve8deZ8.0V511i/CmT6VguxLJFMuHfBnU4.4KqzW1XuPoNgQ.LU52', 0, 1, 30),
(44, 0, 'Ms. Kaya Schmitt', '+18933719282', 'wunsch.briana@hotmail.com', 'albina43', '$2y$10$Rw3U5B4Qwisd5HJVHdDrCeKv3mlCjIkE3sKQRJUWhRF/uikmXFJQG', 0, 6, 19),
(45, 0, 'Madisyn Mayer', '841.599.5874 x1', 'kemmer.sofia@olson.com', 'krystal.kuhic', '$2y$10$KEttblgdqsb.bqTKhldNgeYwk3T1Y1sjJTvUFR5815Bi29x/mdh3K', 0, 1, 3),
(46, 0, 'Major Considine PhD', '1-219-839-8540 ', 'flossie65@bins.biz', 'emard.laisha', '$2y$10$GnzqRN9LJ5Z4b8uHKJzch.aE/5xjTVvFMcvLMda/3bm2KuQjy9tHK', 1, 6, 39),
(47, 0, 'Maynard Zboncak', '+1-825-512-3188', 'karolann53@mitchell.com', 'brandyn.gleason', '$2y$10$LZzt8D4nlSv942ed50vRQu5bo15pw4f/.gs8BW97k8KnfseVgFxJ6', 0, 6, 29),
(48, 0, 'Juliet Pfeffer', '1-809-948-1936 ', 'taya46@daugherty.org', 'jacobi.carolyne', '$2y$10$/9P4otZMDQHgtlIJhwPaf.bbnTLBApEel86XMqKlBfEUSqKVw18i2', 1, 6, 43),
(49, 0, 'Jovany Bernier', '753-859-0035 x8', 'jkub@schuster.com', 'zreinger', '$2y$10$JwahG77bbp68mewO8XiRG.cWtv6rPq7IDC.mHex6extIF7w23GQ8m', 0, 6, 26),
(50, 0, 'Elroy McLaughlin', '(492) 555-9096 ', 'rmraz@windler.com', 'scot35', '$2y$10$X7IcAE.PbEdutim3771KXuJyM80PUdGer8f..5O7BOSfhwfL3UOCm', 1, 6, 40);
